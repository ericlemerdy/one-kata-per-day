...
public class PokerHandTest {
    ...
    public void with_a_straight_flush() {
        Deck deck = new Deck();
        Deck.PokerHand hand = deck.black()
                .addCard(Value._7, Suit.diamond)
    ...
    public void with_an_unsorted_hand_should_recognize_straight_flush() {
        ...
        Deck.PokerHand hand = deck.black()
                .addCard(Value._7, Suit.diamond)
                .addCard(Value.Jack, Suit.diamond)
                .addCard(Value._9, Suit.diamond)
                .addCard(Value._10, Suit.diamond)
                .addCard(Value._8, Suit.diamond).player();
